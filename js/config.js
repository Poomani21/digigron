/* DigiGron site configuration — edit brand values in one place. */
window.SITE_CONFIG = {
  brand: "DigiGron",
  tagline: "Digital Growth Hub — SEO, SEM, SMM and more.",
  contact: {
  ...
  social: {
    instagram: "https://www.instagram.com/digigron.official/",
    linkedin: "#",
    twitter: "#",
  },
  nav: [
